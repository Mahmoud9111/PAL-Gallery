...
const Choose = () => {
    ...
    return (
        <section className="choose-section w-full h-dvh p-8 pt-10 bg-white">
            <p className='text-[1.4rem] lg:text-[1.6rem] text-[#eae5dd] choose-subtitle'>Discover Available Capsule<span>®</span></p>
            ...
            <div className="choose-sec w-full flex lg:flex-row flex-col justify-center items-start gap-10 lg:mt-0">
                ...
                <div className='lg:w-1/2 w-full'>
                    <div className="lg:w-[30%] w-[60%]">
                        <p className="text-[1.4rem] lg:text-[1.6rem] text-[#eae5dd]">All Capsules® houses—has built
                            based on the same rules:</p>
                    </div>
                    <div className="flex flex-1 flex-wrap justify-start items-start gap-2 mt-8">
                        <div className="border-[1px] border-[#b1a696] text-[#b1a696] lg:text-[3rem] text-[1.6rem] px-[28px] py-[8px] rounded-full">
                            Sustainable
                        </div>
                        <div className="border-[1px] border-[#f4efe7] text-[#f4efe7] lg:text-[3rem] text-[1.6rem] px-[28px] py-[8px] rounded-full">
                            Nature—Care
                        </div>
                        <div className="border-[1px] border-[#b1a696] text-[#b1a696] lg:text-[3rem] text-[1.6rem] px-[28px] py-[8px] rounded-full">
                            Smart
